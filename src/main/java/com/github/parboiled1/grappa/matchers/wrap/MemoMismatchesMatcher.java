...
package com.github.parboiled1.grappa.matchers.wrap;
    ...
    implements Matcher
{
     ...
     * @return the given instance if it is not a MemoMismatchesMatcher,
     * otherwise the innermost Matcher
     */
