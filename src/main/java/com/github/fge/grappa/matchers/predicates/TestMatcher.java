...
/**
 * A "positive lookahead" matcher
 *
 * <p>This is the matcher used by {@link BaseParser#test(Object) test()}. This
 * matcher will run its submatcher and declare success if the submatcher
 * succeeds.</p>
 *
