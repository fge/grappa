...
@Immutable
@Beta
public final class CaseInsensitiveTrieNode
{
    private final boolean fullWord;

    private final char[] nextChars;
    private final CaseInsensitiveTrieNode[] nextNodes;

    @SuppressWarnings("MethodCanBeVariableArityMethod")
    CaseInsensitiveTrieNode(final boolean fullWord, final char[] nextChars,
