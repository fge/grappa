    ...
    public void testRuleMethodRewriting() throws Exception {
        assertEquals(getMethodInstructionList(processMethod("RuleWithIndirectImplicitAction", processors))
            .replaceAll("(?<=\\$)[A-Za-z0-9]{16}", "XXXXXXXXXXXXXXXX"), "" +
                ...
                " 7     DUP\n" +
                " 8     ICONST_0\n" +
                " 9     NEW org/parboiled/transform/Action$XXXXXXXXXXXXXXXX\n" +
                "10     DUP\n" +
                "11     LDC \"RuleWithIndirectImplicitAction_Action1\"\n" +
                "12     INVOKESPECIAL org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.<init> (Ljava/lang/String;)V\n" +
                "13     DUP\n" +
                "14     ALOAD 0\n" +
        ...
        assertEquals(getMethodInstructionList(processMethod("RuleWithComplexActionSetup", processors))
            .replaceAll("(?<=\\$)[A-Za-z0-9]{16}", "XXXXXXXXXXXXXXXX"), "" +
                ...
                " 5     DUP\n" +
                " 6     NEW org/parboiled/transform/VarInit$XXXXXXXXXXXXXXXX\n" +
                " 7     DUP\n" +
                ...
                "25     NEW org/parboiled/transform/Action$XXXXXXXXXXXXXXXX\n" +
                "26     DUP\n" +
                "27     LDC \"RuleWithComplexActionSetup_Action1\"\n" +
                "28     INVOKESPECIAL org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.<init> (Ljava/lang/String;)V\n" +
                "29     DUP\n" +
                "30     ILOAD 2\n" +
                "31     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$0 : I\n" +
                "32     DUP\n" +
                "33     ILOAD 1\n" +
                "34     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$1 : I\n" +
                "35     DUP\n" +
                "36     ILOAD 3\n" +
                "37     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$2 : I\n" +
                "38     ICONST_2\n" +
                ...
                "44     DUP\n" +
                "45     ICONST_1\n" +
                "46     NEW org/parboiled/transform/Action$XXXXXXXXXXXXXXXX\n" +
                "47     DUP\n" +
                "48     LDC \"RuleWithComplexActionSetup_Action2\"\n" +
                "49     INVOKESPECIAL org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.<init> (Ljava/lang/String;)V\n" +
                "50     DUP\n" +
                "51     ALOAD 0\n" +
                "52     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$0 : Lorg/parboiled/transform/TestParser$$parboiled;\n" +
                "53     DUP\n" +
                "54     ILOAD 1\n" +
                "55     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$1 : I\n" +
                "56     DUP\n" +
                "57     ALOAD 4\n" +
                "58     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$2 : Lorg/parboiled/support/Var;\n" +
                "59     DUP\n" +
                "60     ILOAD 2\n" +
                "61     PUTFIELD org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.field$3 : I\n" +
                "62     DUP\n" +
                "63     ILOAD 3\n" +
