...
public class ParserHierarchyTest {
    ...
    static class Parser3 extends Parser2 {
        ...
        Rule D() {
            return sequence(A(), super.B(), B(), dup());
        }
    }
    ...
    public void verifyTestParserHierarchyExtension() throws Exception {
        ...
        assertEquals(getMethodInstructionList(classNode.getRuleMethods().get("A()Lorg/parboiled/Rule;")), "" +
                ...
                "26    L1\n" +
                "27     DUP_X1\n" +
                "28     CHECKCAST com/github/parboiled1/grappa/matchers/base/Matcher\n" +
                "29     INVOKEVIRTUAL com/github/parboiled1/grappa/matchers/wrap/ProxyMatcher.arm (Lcom/github/parboiled1/grappa/matchers/base/Matcher;)V\n" +
                "30     DUP\n" +
                "31     ALOAD 0\n" +
                "32     SWAP\n" +
        ...
        assertEquals(getMethodInstructionList(classNode.getRuleMethods().get("$B()Lorg/parboiled/Rule;"))
            .replaceAll("(?<=\\$)[A-Za-z0-9]{16}", "XXXXXXXXXXXXXXXX"), "" +
                ...
                " 4     DUP\n" +
                " 5     LDC \"$B_Action1\"\n" +
                " 6     INVOKESPECIAL org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.<init> (Ljava/lang/String;)V\n" +
                " 7     DUP\n" +
                " 8     ALOAD 0\n" +
        ...
        assertEquals(getMethodInstructionList(classNode.getRuleMethods().get("B()Lorg/parboiled/Rule;"))
            .replaceAll("(?<=\\$)[A-Za-z0-9]{16}", "XXXXXXXXXXXXXXXX"), "" +
                ...
                "21     DUP\n" +
                "22     ICONST_0\n" +
                "23     NEW org/parboiled/transform/Action$XXXXXXXXXXXXXXXX\n" +
                "24     DUP\n" +
                "25     LDC \"B_Action1\"\n" +
                "26     INVOKESPECIAL org/parboiled/transform/Action$XXXXXXXXXXXXXXXX.<init> (Ljava/lang/String;)V\n" +
                "27     DUP\n" +
                "28     ALOAD 0\n" +
                ...
                "36    L1\n" +
                "37     DUP_X1\n" +
                "38     CHECKCAST com/github/parboiled1/grappa/matchers/base/Matcher\n" +
                "39     INVOKEVIRTUAL com/github/parboiled1/grappa/matchers/wrap/ProxyMatcher.arm (Lcom/github/parboiled1/grappa/matchers/base/Matcher;)V\n" +
                "40     DUP\n" +
                "41     ALOAD 0\n" +
                "42     SWAP\n" +
